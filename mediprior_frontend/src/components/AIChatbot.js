...
import { FiMessageCircle, FiX, FiSend, FiTrash2 } from 'react-icons/fi'; // <-- Import FiTrash2
    ...
    return (
        <Card className="theme-card" style={styles.chatWindow}>
            ...
            <div className="p-3 border-bottom d-flex justify-content-between align-items-center" style={{background: 'var(--bg-secondary)'}}>
                ...
                <div>
                    {/* CLEAR BUTTON */}
                    <Button variant="link" className="text-muted p-0 me-3" onClick={clearChat} title="Clear Chat">
                        <FiTrash2 size={20} />
                    </Button>
